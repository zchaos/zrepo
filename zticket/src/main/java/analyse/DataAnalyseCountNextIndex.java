 ...
 */
public class DataAnalyseCountNextIndex {
	...
	public DataAnalyseCountNextIndex(double[] datas) {
		this(datas, -1, -1);
	}

	public DataAnalyseCountNextIndex(double[] datas, int initcount, int limit) {
		this.datas = datas;
